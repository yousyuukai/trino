...
{
    private static final Logger LOG = Logger.get(SalesforceClient.class);

    @Inject
    public SalesforceClient(BaseJdbcConfig config, ConnectionFactory connectionFactory, IdentifierMapping identifierMapping)
    {
