...
{
    private static final Logger LOG = Logger.get(KintoneClient.class);

    @Inject
    public KintoneClient(BaseJdbcConfig config, ConnectionFactory connectionFactory, IdentifierMapping identifierMapping)
    {
